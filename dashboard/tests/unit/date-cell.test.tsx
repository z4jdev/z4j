...
describe("DateCell", () => {
  it("renders one line with the absolute time on hover when compact", () => {
    const { container } = render(<DateCell value={when} compact />);
  ...
  it("renders the absolute time on its own line otherwise", () => {
